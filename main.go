...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligenc1 password=root host=/cloudsql/chicago-business-intelligence:us-central1:mypostgres sslmode=disable port = 5432"
